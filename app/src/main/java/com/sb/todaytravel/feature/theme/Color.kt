...
val TodayTravelGreen = Color(0xFF0FFF0F)
val TodayTravelGray = Color(0xFFEFEFEF)
val TodayTravelOrange = Color(0xFFFFAF00)
val TodayTravelDarkGray = Color(0xFF7F7F7F)